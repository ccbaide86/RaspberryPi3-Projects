...
# ENCENDIDO
def evaluarCombo17():
    if combo17.get() == "ENCENDER LUZ ROJA SH":
        print("ROJO ENCENDIDO SH")
        os.system("sudo /./home/sa/sh/off17.sh")
        os.system("pkill onoff17.sh")
    elif combo17.get() == "APAGAR LUZ ROJA SH":
        print("ROJO APAGADO SH")
        os.system("sudo /./home/sa/sh/on17.sh")
    elif combo17.get() == "PARPADEO DE LUZ ROJA SH":
        print("ROJO PARPADEANDO SH")
        os.system("sudo /./home/sa/sh/onoff17.sh")
    elif combo17.get() == "ENCENDER LUZ ROJA C":
        print("ROJO ENCENDIDO C")
        os.system("sudo /./home/sa/c/off17")
    elif combo17.get() == "APAGAR LUZ ROJA C":
        print("ROJO APAGADO C")
        os.system("sudo /./home/sa/c/on17")

def evaluarCombo22():
    if combo22.get() == "ENCENDER LUZ AMARILLO SH":
        print("AMARILLO ENCENDIDO SH")
        os.system("sudo /./home/sa/sh/off22.sh")
        os.system("pkill onoff22.sh")
    elif combo22.get() == "APAGAR LUZ AMARILLO SH":
        print("AMARILLO APAGADO SH")
        os.system("sudo /./home/sa/sh/on22.sh")
    elif combo22.get() == "PARPADEO DE LUZ AMARILLO SH":
        print("AMARILLO PARPADEANDO SH")
        os.system("sudo /./home/sa/sh/onoff22.sh")
    elif combo22.get() == "ENCENDER LUZ AMARILLO C":
        print("AMARILLO ENCENDIDO C")
        os.system("sudo /./home/sa/c/off22")
    elif combo22.get() == "APAGAR LUZ AMARILLO C":
        print("AMARILLO APAGADO C")
        os.system("sudo /./home/sa/c/on22")

def evaluarCombo27():
    if combo27.get() == "ENCENDER LUZ VERDE SH":
        print("VERDE ENCENDIDO")
        os.system("sudo /./home/sa/sh/off27.sh")
        os.system("pkill onoff27.sh")
    elif combo27.get() == "APAGAR LUZ VERDE SH":
        print("VERDE APAGADO")
        os.system("sudo /./home/sa/sh/on27.sh")
    elif combo27.get() == "PARPADEO DE LUZ VERDE SH":
        print("VERDE PARPADEANDO")
        os.system("sudo /./home/sa/sh/onoff27.sh")
    elif combo27.get() == "ENCENDER LUZ VERDE C":
        print("VERDE ENCENDIDO C")
        os.system("sudo /./home/sa/c/off27")
    elif combo27.get() == "APAGAR LUZ VERDE C":
        print("VERDE APAGADO C")
        os.system("sudo /./home/sa/c/on27")

def evaluarCombo21():
    if combo21.get() == "ENCENDER BUZZER SH":
        print("BUZZER ENCENDIDO")
        os.system("sudo /./home/sa/sh/off21.sh")
        os.system("pkill onoff21.sh")
    elif combo21.get() == "APAGAR BUZZER SH":
        print("BUZZER APAGADO")
        os.system("sudo /./home/sa/sh/on21.sh")
    elif combo21.get() == "PARPADEO DE BUZZER SH":
        print("BUZZER PARPADEANDO")
        os.system("sudo /./home/sa/sh/onoff21.sh")
    elif combo21.get() == "ENCENDER BUZZER C":
        print("BUZZER ENCENDIDO C")
        os.system("sudo /./home/sa/c/off21")
    elif combo21.get() == "APAGAR BUZZER C":
        print("BUZZER APAGADO C")
        os.system("sudo /./home/sa/c/on21")

# Combobox
label_titulo17 = Label(v0, text="Control luz roja", font=text3).place(x=23, y=235)
combo17 = StringVar()
c17 = ttk.Combobox(v0, textvariable=combo17, values=["ENCENDER LUZ ROJA SH", "APAGAR LUZ ROJA SH", "PARPADEO DE LUZ ROJA SH", "ENCENDER LUZ ROJA C", "APAGAR LUZ ROJA C"])
...
combo22 = StringVar()
c22 = ttk.Combobox(v0, textvariable=combo22, values=["ENCENDER LUZ AMARILLO SH", "APAGAR LUZ AMARILLO SH", "PARPADEO DE LUZ AMARILLO SH", "ENCENDER LUZ AMARILLO C", "APAGAR LUZ AMARILLO C"])
...
combo27 = StringVar()
c27 = ttk.Combobox(v0, textvariable=combo27, values=["ENCENDER LUZ VERDE SH", "APAGAR LUZ VERDE SH", "PARPADEO DE LUZ VERDE SH", "ENCENDER LUZ VERDE C", "APAGAR LUZ VERDE C"])
...
combo21 = StringVar()
c21 = ttk.Combobox(v0, textvariable=combo21, values=["ENCENDER BUZZER SH", "APAGAR BUZZER SH", "PARPADEO DE BUZZER SH", "ENCENDER BUZZER C", "APAGAR BUZZER C"])
